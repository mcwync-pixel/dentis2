          ...
          <div>
            <a href="#home" className="flex items-center gap-3">
              ...
              <span className="flex flex-col leading-tight">
                <span className="font-display text-xl font-semibold text-white">Aura Dental</span>
                <span className="text-[11px] font-medium uppercase tracking-[0.18em] text-brand-400">Green Valley</span>
              </span>
            </a>
            <p className="mt-6 max-w-md text-sm leading-relaxed text-slate-400">
              Dentist servicing Green Valley, Oakwood, Riverdale, Kingswood and the surrounding Metro Area.
            </p>
          ...
          <div>
            ...
            <ul className="mt-5 space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <a href="tel:0255550199" className="text-slate-400 hover:text-white">(02) 5555 0199</a>
              </li>
              <li className="flex items-start gap-3">
